            ...
            <div className={`accordion-content`}>
              ...
              >
                {chapter.lectures.map((lecture) => (
                  ...
                  >
                    <span className="absolute flex items-center justify-center w-4 h-4  rounded-full -right-2  bg-primary/30"></span>

                    <h3 className="text-base font-semibold text-gray-200 flex items-center justify-between">
                      {lecture.title}
