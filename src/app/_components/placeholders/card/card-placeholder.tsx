'use client'
import { CartPlaceholderProps } from "./card-placeholder-types";


export const CardPlaceholder:React.FC<CartPlaceholderProps>=({className,count=1}:CartPlaceholderProps)=>{
